...
| Скрипт | Призначення |
| --- | --- |
| <a href="/tools/imgbed-token-manage.mjs" download>Завантажити скрипт керування файлами</a> | Метадані файлів, мітки модерації, теги файлів, статус списків, переміщення, перейменування, створення папок, блокування/відновлення IP, створення і видалення короткострокових Token для завантаження |
