...
Це фіксований канал через binding. Його не потрібно створювати кнопкою Додати канал, і його не можна видалити як звичайний канал.
...
7. Поверніться до `ImgBed -> Налаштування системи -> Налаштування завантаження`.
