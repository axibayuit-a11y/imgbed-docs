...
> ImgBed를 처음 사용하기 전에는 초기화 페이지로 이동해 "인덱스 재구축"을 클릭하여 필요한 D1 데이터 테이블을 보완하고 이후 기능 오류를 방지해야 합니다.
>
> ![초기화 시 인덱스 재구축 클릭](../../image/初始化点击重建索引.png)

- 사용할 저장소 계정 또는 API 자격 증명을 준비합니다.
- OAuth 기반 채널은 콜백 URL이 필요하므로 ImgBed 도메인에 접근할 수 있는지 확인합니다.
