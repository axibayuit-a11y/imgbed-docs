...
| اسکریپت | کاربرد |
| --- | --- |
| <a href="/tools/imgbed-token-manage.mjs" download>دانلود اسکریپت مدیریت فایل</a> | فراداده فایل، برچسب‌های بازبینی، برچسب‌های فایل، وضعیت فهرست، جابه‌جایی، تغییرنام، ساخت پوشه، مسدودسازی/رفع مسدودسازی IP، ساخت و حذف Token آپلود کوتاه‌مدت |
