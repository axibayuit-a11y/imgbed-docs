...
| اسکریپت | کاربرد |
| --- | --- |
| <a href="/tools/imgbed-token-list.mjs" download>دانلود اسکریپت فهرست‌گیری و فیلتر</a> | فهرست مدیریت فایل، فهرست مدیریت کاربران، فهرست کانال‌های آپلود و جدول آمار پوشه‌ها |
