...
- [Yükleme kanalları](./upload/)
- [Güvenlik ayarları](./Safety/authentication-and-login-devices.md)
- [Herkese açık galeri, blog, federasyon ve diğer özellikler](./Other/random-image-api-and-public-gallery.md)
- [Sayfa ayarları](./Page/page-settings.md)
...
Belgeleri kullanırken veya ImgBed'i dağıtırken sorun yaşarsanız, lütfen [GitHub Issues](https://github.com/axibayuit-a11y/imgbed-docs/issues) üzerinden bildirin. Bu dokümantasyon deposu open source, geri bildirimlere göre geliştirmeye devam edeceğiz.

E-posta ile de ulaşabilirsiniz: <axibayuit@gmail.com>
