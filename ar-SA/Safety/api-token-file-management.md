...
| السكربت | الغرض |
| --- | --- |
| <a href="/tools/imgbed-token-manage.mjs" download>تنزيل سكربت إدارة الملفات</a> | بيانات الملفات الوصفية، وتصنيفات المراجعة، ووسوم الملفات، وحالة القوائم، والنقل، وإعادة التسمية، وإنشاء المجلدات، وحظر عناوين IP أو السماح بها، وإنشاء وحذف Tokens الرفع قصيرة الأجل |
