...
![编辑 API Token](../../image/Safety/apitoken/编辑api token.png)
...
| 脚本 | 用途 |
| --- | --- |
| <a href="/tools/imgbed-token-single-upload.mjs" download>下载单次上传脚本</a> | 只调用一次 `/upload`，适合小文件和接口连通性测试 |
| <a href="/tools/imgbed-token-chunk-upload.mjs" download>下载分块上传脚本</a> | 使用 API Token 的分块、直传或平台会话接口，适合大文件 |
