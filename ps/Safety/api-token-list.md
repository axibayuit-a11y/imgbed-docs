...
| سکریپټ | کار |
| --- | --- |
| <a href="/tools/imgbed-token-list.mjs" download>د لړلیک او چاڼ سکریپټ</a> | د فایلونو مدیریت لړلیک، د کاروونکو مدیریت لړلیک، د پورته کولو چینلونو لړلیک، د پوښیو شمېرنو جدول |
