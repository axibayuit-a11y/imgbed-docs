...
- 🔒 data مکمل طور پر آپ کے control میں رہتا ہے۔ کوئی third party آپ کا content دیکھ یا delete نہیں کر سکتی
...
- [اپ لوڈ چینلز](./upload/)
- [سیکیورٹی سیٹنگز](./Safety/authentication-and-login-devices.md)
- [Public gallery، blog، federation اور دیگر خصوصیات](./Other/random-image-api-and-public-gallery.md)
- [صفحہ سیٹنگز](./Page/page-settings.md)
...
## Feedback اور مسئلہ رپورٹ

اگر documentation استعمال کرتے وقت یا ImgBed deploy کرتے وقت مسئلہ آئے، تو اسے [GitHub Issues](https://github.com/axibayuit-a11y/imgbed-docs/issues) میں report کریں۔ یہ docs repository open source ہے، اور ہم feedback کے مطابق اسے بہتر کرتے رہیں گے۔

آپ email سے بھی رابطہ کر سکتے ہیں: <axibayuit@gmail.com>
