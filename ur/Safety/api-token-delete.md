...
![API Token میں ترمیم](../../image/Safety/apitoken/编辑删除权限api.png)
...
| اسکرپٹ | مقصد |
| --- | --- |
| <a href="/tools/imgbed-token-delete.mjs" download>فائل حذف کاری اسکرپٹ</a> | ایک یا زیادہ واضح طور پر دی گئی file IDs حذف کریں۔ |
