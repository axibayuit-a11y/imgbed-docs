...
| Скрипт | Назначение |
| --- | --- |
| <a href="/tools/imgbed-token-manage.mjs" download>Скачать скрипт управления файлами</a> | Метаданные файлов, метки модерации, теги файлов, статус списков, перемещение, переименование, создание папок, блокировка/восстановление IP, создание и удаление краткосрочных Token для загрузки |
