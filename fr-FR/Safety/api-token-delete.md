...
| Script | Utilisation |
| --- | --- |
| <a href="/tools/imgbed-token-delete.mjs" download>script de suppression de fichiers</a> | Supprime un ou plusieurs identifiants de fichiers indiqués explicitement |
